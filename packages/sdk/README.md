...
解决了前端不用后端自己部署埋点监控系统，一键自动部署到cloudflare平台上，简单、安全、支持二开
...
```bash
npm install @web-analyze/sdk
# 或
pnpm add @web-analyze/sdk
# 或
yarn add @web-analyze/sdk
```
...
**先去[github](https://github.com/Guidozijef/web-analytics)部署后台监控平台，在进行前端sdk安装配置**
...
```typescript
import { setUser, clearUser } from "@web-analyze/sdk";
...
```typescript
import { track } from "@web-analyze/sdk";
...
```typescript
import { flush } from "@web-analyze/sdk";
